...
const Home: React.FC<HomeProps> = ({ navigation }) => {
  ...
  const sponsoredOffers: SponsoredOffer[] = [
    ...
    },
    {
      ...
      salon: "Luxe Beauty",
      image:
        "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400&h=200&fit=crop",
      expiry: "Limited time",
  ...
  const categories: Category[] = [
    ...
    },
    {
      name: "Nail Salon",
      image:
        "https://images.unsplash.com/photo-1607778833979-4cc7b3e12e0e?w=200&h=200&fit=crop&crop=center",
      count: "156 studios",
    },
    {
      name: "Beauty Spa",
      image:
        "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=200&h=200&fit=crop&crop=center",
      count: "203 spas",
    },
    {
      name: "Massage",
    ...
    },
    {
      name: "Waxing",
      image:
        "https://images.unsplash.com/photo-1594736797933-d0ea3ff8db41?w=200&h=200&fit=crop&crop=center",
      count: "87 studios",
    },
  ];
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <BestRatedProfessionalsSection professionals={bestRatedProfessionals} />
